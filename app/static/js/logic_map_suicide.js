...
let overlays = {
  ...
  "Adult's With Suicidal Ideation 2019": results2019,
  "Adult's With Suicidal Ideation 2020": results2020,
  "Adult's With Suicidal Ideation 2021": results2021
...
$.getJSON(link,function(data){
  function styleInfo(feature) {
    return {
      opacity: 1,
      fillOpacity: 1,
      fillColor: getColor(feature.properties.percent_adult_suicide_2019),
      color: "#000000",
      radius: getRadius(feature.properties.pop_adult_suicide_2019),
      stroke: true,
      weight: 0.5,
      pane: 'markerPane'
    };
  ...
  L.geoJson(data,{
    ...
    style: styleInfo,
     ...
     onEachFeature: function(feature, layer) {
      ...
      "<br> <b>Rank:</b> " + feature.properties.Rank_adult_suicide_2019 +
      "<br> <b>Population of Respondents:</b> " + feature.properties.pop_adult_suicide_2019 +
      "<br> <b>Percentage of Respondents:</b> " + feature.properties.percent_adult_suicide_2019 +
  ...
  $.getJSON(link,function(data){
    function styleInfo(feature) {
      return {
        opacity: 1,
        fillOpacity: 1,
        fillColor: getColor(feature.properties.percent_adult_suicide_2020),
        color: "#000000",
        radius: getRadius(feature.properties.pop_adult_suicide_2020),
        weight: 0.5,
        pane: 'markerPane'
      };
    }
     ...
     // We turn each feature into a circleMarker on the map.
      ...
      style: styleInfo,
       ...
       onEachFeature: function(feature, layer) {
        ...
        "<br> <b>Rank:</b> " + feature.properties.Rank_adult_suicide_2020 +
        "<br><b>Population of Respondents:</b> " + feature.properties.pop_adult_suicide_2020 +
        "<br><b>Percentage of Respondents:</b> " + feature.properties.percent_adult_suicide_2020 +
    ...
    $.getJSON(link,function(data){
      function styleInfo(feature) {
        return {
          opacity: 1,
          fillOpacity: 1,
          fillColor: getColor(feature.properties.percent_adult_suicide_2021),
          color: "#000000",
          radius: getRadius(feature.properties.pop_adult_suicide_2021),
          stroke: true,
          weight: 0.5,
          pane: 'markerPane'
        };
    ...
    // This function determines the color of the marker based percentage of respondents.
      ...
      L.geoJson(data,{
        ...
        style: styleInfo,
          ...
          onEachFeature: function(feature, layer) {
          layer.bindPopup("<b>State:</b> " + feature.properties.State + 
          "<br> <b>Rank:</b> " + feature.properties.Rank_adult_suicide_2021 +
          "<br> <b>Population of Respondents:</b> " + feature.properties.pop_adult_suicide_2021 +
          "<br><b>Percentage of Respondents:</b> " + feature.properties.percent_adult_suicide_2021 + 
  ...
  legend.onAdd = function() {
    ...
    const percentage = [0, 3.5, 3.7, 4, 4.3, 5.3];
    const colors = [
      "#98ee00",
      "#d4ee00",
      "#eecc00",
