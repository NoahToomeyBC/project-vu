...
$.getJSON(link,function(data){
  function styleInfo(feature) {
    return {
      opacity: 1,
      fillOpacity: 1,
      fillColor: getColor(feature.properties.percent_no_doc_adult2019),
      color: "#000000",
      radius: getRadius(feature.properties.pop_no_doc_adult2019),
      stroke: true,
      weight: 0.5,
      pane: 'markerPane'
    };
  ...
  L.geoJson(data,{
    ...
    style: styleInfo,
     ...
     onEachFeature: function(feature, layer) {
      ...
      "<br> <b>Rank:</b> " + feature.properties.Rank_no_doc_adult2019 +
      "<br> <b>Population of Respondents:</b> " + feature.properties.pop_no_doc_adult2019 +
      "<br> <b>Percentage of Respondents:</b> " + feature.properties.percent_no_doc_adult2019 +
  ...
  $.getJSON(link,function(data){
    function styleInfo(feature) {
      return {
        opacity: 1,
        fillOpacity: 1,
        fillColor: getColor(feature.properties.percent_disability_adults_nodoc_2020),
        color: "#000000",
        radius: getRadius(feature.properties.pop_disability_adults_nodoc_2020),
        weight: 0.5,
        pane: 'markerPane'
      };
    }
...
// This function determines the radius of the marker based on population
     ...
     // We turn each feature into a circleMarker on the map.
      ...
      style: styleInfo,
       ...
       onEachFeature: function(feature, layer) {
        ...
        "<br> <b>Rank:</b> " + feature.properties.Rank_disability_adults_nodoc_2020 +
        "<br><b>Population of Respondents:</b> " + feature.properties.pop_disability_adults_nodoc_2020 +
        "<br><b>Percentage of Respondents:</b> " + feature.properties.percent_disability_adults_nodoc_2020 +
    ...
    $.getJSON(link,function(data){
      function styleInfo(feature) {
        return {
          opacity: 1,
          fillOpacity: 1,
          fillColor: getColor(feature.properties.percent_disability_adults_nodoc_2021),
          color: "#000000",
          radius: getRadius(feature.properties.pop_disability_adults_nodoc_2021),
          stroke: true,
          weight: 0.5,
          pane: 'markerPane'
        };
      ...
      L.geoJson(data,{
        ...
        style: styleInfo,
          ...
          onEachFeature: function(feature, layer) {
          layer.bindPopup("<b>State:</b> " + feature.properties.State + 
          "<br> <b>Rank:</b> " + feature.properties.Rank_disability_adults_nodoc_2021 +
          "<br> <b>Population of Respondents:</b> " + feature.properties.pop_disability_adults_nodoc_2021 +
          "<br><b>Percentage of Respondents:</b> " + feature.properties.percent_adult_disability_adults_nodoc_2021 + 
  ...
  legend2.onAdd = function() {
    ...
    const percentage2 = [ 0,.85,.87,.9,.92, .94, .945, .95, .955, .96, 96.5,.97, 97.5];
    const colors2 = [
      "#006d2c",
      "#013220",
      "#238b45", 
